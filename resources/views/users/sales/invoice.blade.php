	...
	<div class="card shadow mb-4">
	    ...
	    <table class="table">
	    	...
	    	<tbody>
	    		...
	    		<tr>
	    			<th colspan="4" class="text-right"><strong>Paid:</strong></th>
	    			<th>{{ $totalPaid=$invoice->selrecives()->sum('amount') }}</th>
	    		</tr>
	    		<tr>
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		      <div class="modal-header">
		        <h5 class="modal-title" id="exampleModalLabel">New Sale Item</h5>
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
    			...
    			{!! Form::open([ 'route' => ['user.recive.store', ['id' => $user->id, 'invoice_id' => $invoice->id]], 'method' => 'post' ]) !!}
